...
namespace Jakar.Api.iOS.Extensions
{
	public static partial class LayoutExtensions
	{
		...
		public static void InBetween( this UIView view, in UIView parent, in UIView left, in UIView right ) =>
			view.SetBounds(parent.TopAnchor, parent.BottomAnchor, right.LeftAnchor, left.RightAnchor);


		public static void SetBounds( this UIView view, in UIView parent, in bool translate = false ) => view.SetBounds(parent.TopAnchor,
																														parent.BottomAnchor,
																														parent.LeftAnchor,
																														parent.RightAnchor,
																														translate);

		public static void SetBounds( this UIView view,
