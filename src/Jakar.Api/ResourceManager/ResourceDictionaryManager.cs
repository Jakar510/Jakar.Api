...
namespace Jakar.Api.ResourceManager
{
																									  ...
																									  where TKey : Enum
	{
		...
		/// <param name="property"></param>
		/// <param name="key"></param>
		public void BindAppTheme<TValue>( in BindableObject bindable, in BindableProperty property, in TThemedKey key )
		{
			bindable.SetOnAppTheme(property, Get<TValue>(OSAppTheme.Light, key), Get<TValue>(OSAppTheme.Dark, key));
		}
	}
