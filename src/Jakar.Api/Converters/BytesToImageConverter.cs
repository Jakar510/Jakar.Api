...
namespace Jakar.Api.Converters
{
	public class BytesToImageConverter : IValueConverter
	{
		...
		public object? Convert( object value, Type targetType, object parameter, CultureInfo culture ) { return CanConvert(value.GetType()) ? ImageSource.FromStream(() => new MemoryStream((byte[]) value ?? throw new NullReferenceException(nameof(value)))) : null; }
