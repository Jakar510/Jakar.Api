...
namespace Jakar.Api.Statics
{
	public static class AppShare
	{
		...
		public static Task<LocalFile?> OpenOfficeDoc( this Uri link, string shareTitle, MimeType mime, IAppSettings settings ) =>
			link.OpenOfficeDoc(shareTitle, mime, settings.AppName);
